...
<head>
    ...
    <title>Drazic Tunning Car - Cancelar serviço</title>
</head>
<body>
    <?php
    ...
    ?>
    <div class="container">
        <h1 class="mt-5">Cancelar registro de serviço</h1>
        <form action="../Database/dbServices/removeService.php" method="post">
            ...
            <button type="submit" class="btn btn-danger">Cancelar serviço</button>
        </form>
    </div>
</body>
</html>