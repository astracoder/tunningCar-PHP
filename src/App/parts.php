...
<head>
    ...
    <title>Drazic Tunning Car - Peças</title>
</head>
<body>
<?php
...
<div class="container-fluid">
        ...
        <div class="col-md-6 m-3 p-3">
            ...
            <form action="../../src/Database/dbParts/addParts.php" method="post">
                <div class="mb-3">
                    <label class="form-label" for="partModel">Marca da peça</label>
                    <input class="form-control" id="partModel" type="text" name="partBrand" placeholder="Digite a marca da peça...">
                    <?php 
                        session_start();
    ...
    <div class="container">
        <?php
            ...
            if (!empty($parts)) {
                ...
                echo '<tbody>';
                foreach ($parts as $parts) { //Loop no array e pegando registro por registro e colcando nas tabelas
                    echo '<tr>';
                    echo '<td>' . $parts['id'] . '</td>';
                    echo '<td>' . $parts['partBrand'] . '</td>';
                    echo '<td>' . $parts['partModel'] . '</td>';
                    echo '<td>' . $parts['fabricationDate'] . '</td>';
                    echo '</tr>';
                }
                echo '</tbody></table>';
            } else {
