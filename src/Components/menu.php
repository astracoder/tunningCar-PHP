        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active text-danger" aria-current="page" href="index.php">Dashboard</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="ml-auto">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#dc3545" class="bi bi-person-circle" viewBox="0 0 16 16">
                ...
                <a class="btn btn-danger ms-2" href="../loginAccount.php">Sair</a>
            </div>
        </div>
    </nav>
</div>