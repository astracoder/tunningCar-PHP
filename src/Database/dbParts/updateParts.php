<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        if($_POST['id'] && $_POST['partBrand'] && $_POST['partModel'] && $_POST['fabricationDate']) {
            $id = $_POST['id'];
            ...
            if(!isset($_SESSION['errorPartBrand']) OR !isset($_SESSION['errorPartModel'])) {
                $sql = "UPDATE parts SET partBrand = '$partBrand', partModel = '$partModel', fabricationDate = '$fabricationDate' WHERE id = '$id'";
            ...
            header('location: ../../App/editParts.php');
            exit();
        }
    } else {
        //Método errado
